...
class newPantryPage extends StatefulWidget {
  @override
  _newPantryPageState createState() => _newPantryPageState();
}

class _newPantryPageState extends State<newPantryPage> {
              ...
              children: [
                ...
                RaisedButton(
                  ...
                  onPressed: (){
                    ...
                    FirebaseDatabase.instance.reference().child("FoodData/PantryData/item"+timestamp.toString()).set(
                        {
